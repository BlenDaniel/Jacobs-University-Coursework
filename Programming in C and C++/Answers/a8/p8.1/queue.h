 ...
 *
 * Print the queue by printing the all stored items. This works by first copying the queue
 * in its original state to a temp queue and priniting by making it's pointers to the next
 * one.
 *
 * @param pq The pointer to the queue structure.
 */
