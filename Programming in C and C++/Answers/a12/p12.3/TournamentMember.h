...
private:
    int number;
    int position;
    //static int numberOfGoalsScored;
...
public: /* Business logic methods are public */
        /* Constructors method declarations */
    Player();
    Player(const char *, const char *, const char *, const char *, const int, const int, const int, const bool);
    Player(const Player &);/* Copy constructor */
    ~Player(); /* Destructor method */
    /* Inline Getter method implementation */
    int getNumber() const { return number; }
    int getPosition() const { return position; }
    bool getIsLeftFooted() const { return isLeftFooted; }
    int getNumberOfGoalsScored() { return numberOfGoalsScored; }
    /* Inline Setter method implementation */
    void setNumber(const int newNumber) { number = newNumber; }
    void setPosition(const int newPosition) { position = newPosition; }
    void setIsLeftFooted(const bool isLeftFoot) { isLeftFooted = isLeftFoot; }
    /* Service method implementation */
    void print();
    void increment();
